...
*The complete codebase, raw evaluation datasets, and diagnostic heatmaps are publicly available on GitHub at [zhongruikang81-sudo/FW-SE-Latent-Diagnostics](https://github.com/zhongruikang81-sudo/FW-SE-Latent-Diagnostics).*
...
First, LLM activations are high-rank. In Gemma-2-2B-IT's deep layers, you need an effective rank of $r_{\text{eff}} = 381$ just to cover 90% of the variance. They don't sit on a neat low-dimensional manifold.
...
For an evaluation batch of $N = 2000$ samples, this means activations occupy a complex space where individual queries contain highly specific, mutually orthogonal semantic components.
